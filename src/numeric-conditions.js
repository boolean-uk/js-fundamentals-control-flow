...
// 1. Use conditional statements to set answerOne to false if ARRAY_ONE is not empty or true if it is empty
const answerOne = ARRAY_ONE.length === 0

// 2. Use conditional statements to set answerTwo to false if ARRAY_TWO is not empty or true if it is empty
