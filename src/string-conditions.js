...
let answerFour
if (STR_FIVE[0].toUpperCase() === STR_FIVE[8].toUpperCase()) {
  answerFour = true
}
...
let answerFive
if (STR_SIX[0].toUpperCase() === STR_SIX[5].toUpperCase()) {
  answerFive = true
} else {
  answerFive = false
}
...
// check if it is odd charcethers
// if it is set answer to middle charecter
// the number % 2 === 0
// STR_seven.charAt()
