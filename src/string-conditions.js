...
const lowerCaseStr = STR_FIVE.toLowerCase();

if (lowerCaseStr.charAt(0)===lowerCaseStr.charAt(lowerCaseStr.length - 1)){
  answerFour = true
...
const lowerCaseStr1 = STR_SIX.toLowerCase();

if (lowerCaseStr1.charAt(0)===lowerCaseStr1.charAt(lowerCaseStr1.length - 1)){
  answerFive = true
} else {
  answerFive = false
}
...
if (STR_SEVEN.length % 2 !== 0){
  ...
  answerSix = STR_SEVEN.substring(middleIndex, middleIndex + 1);
} else {
  answerSix = null;
}
