...
const answerFour =
  (STR_FIVE.startsWith('a') || STR_FIVE.startsWith('A')) &&
  (STR_FIVE.endsWith('a') || STR_FIVE.endsWith('A'))
...
const answerFive =
  (STR_SIX.startsWith('a') || STR_SIX.startsWith('A')) &&
  (STR_SIX.endsWith('a') || STR_SIX.endsWith('A'))

// 6. Use conditional statements to set answerSix to the middle character of STR_SEVEN
// if STR_SEVEN has an odd number of characters
const STR_SEVEN = 'Kayla' // eslint-disable-line no-unused-vars

const answerSix = !(STR_SEVEN.length % 2 === 0)
  ? STR_SEVEN.charAt(STR_SEVEN.length / 2)
  : STR_SEVEN.substring(STR_SEVEN.length / 2, 2)

// 7. Use conditional statements to set answerSeven to the middle two characters of
// STR_EIGHT if STR_EIGHT has an even number of characters
const STR_EIGHT = 'Alex' // eslint-disable-line no-unused-vars

const answerSeven = !(STR_EIGHT.length % 2 === 0)
