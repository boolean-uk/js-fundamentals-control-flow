...
const firstChar = STR_FIVE.charAt(0).toLowerCase()
const lastChar = STR_FIVE.charAt(STR_FIVE.length - 1).toLowerCase()
const answerFour = firstChar === lastChar
...
const firstCharSix = STR_SIX.charAt(0).toLowerCase()
const lastCharSix = STR_SIX.charAt(STR_SIX.length - 1).toLowerCase()
const answerFive = firstCharSix === lastCharSix
...
if (STR_EIGHT.length % 2 === 0) {
  const middleIndexEight = STR_EIGHT.length / 2
  answerSeven = STR_EIGHT.slice(middleIndexEight - 1, middleIndexEight + 1)
}
