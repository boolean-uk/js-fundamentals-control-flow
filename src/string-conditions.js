...
if (STR_FIVE.charAt(0).toLocaleLowerCase() === STR_FIVE.charAt(8)) {
  answerFour = true
}
...
if (STR_SEVEN.length % 2 !== 0) {
  const middleLenght = STR_SEVEN.length / 2
  answerSix = STR_SEVEN.charAt(middleLenght)
}
...
if (MONTH === 'March' || MONTH === 'April' || MONTH === 'May') {
  answerEight = 'Spring'
} else if (MONTH === 'Jun' || MONTH === 'July' || MONTH === 'August') {
  answerEight = 'Summer'
} else if (
  MONTH === 'September' ||
  MONTH === 'October' ||
