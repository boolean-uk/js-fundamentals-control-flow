...
if (STR_FIVE.toLowerCase()[0] === STR_FIVE.toLowerCase()[8]) {
  answerFour = true
}
...
if (STR_SIX.toLowerCase()[0] === STR_SIX.toLowerCase()[5]) {
  answerFive = true
} else {
  answerFive = false
}
...
let answerSix
const strsevenlength = STR_SEVEN.length
const middlechar = (strsevenlength - 1) / 2

if (strsevenlength % 2 !== 0) {
