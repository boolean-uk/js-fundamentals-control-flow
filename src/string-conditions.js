...
const Lastletter = STR_FIVE[8]
console.log(Lastletter)

let Firstletterlowercase = Firstletter.toLowerCase();
console.log(Firstletterlowercase === Lastletter)

if(Firstletterlowercase === Lastletter){
  answerFour = true;
} else {
  answerFour = false;
}
...
const Firstlettersix = STR_SIX[0]
console.log(Firstlettersix)

const Lastlettersix = STR_SIX[5]
console.log(Lastlettersix)

let Firstlettersixlowercase = Firstlettersix.toLowerCase();
console.log(Firstlettersixlowercase === Lastlettersix)

if(Firstlettersixlowercase === Lastlettersix){
  answerFive = true;
} else {
  answerFive = false;
}
...
if (STR_EIGHT.length % 2 === 0) {
  ...
  answerSeven = STR_EIGHT.substr(middleIndex - 1, 2);
}
