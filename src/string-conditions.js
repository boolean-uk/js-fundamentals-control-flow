...
if(STR_SEVEN.length % 2 == 1) {
  answerSix = STR_SEVEN.at((STR_SEVEN.length-1)/2)
}
...
if(STR_EIGHT.length % 2 == 0) {
  answerSeven = STR_EIGHT.slice(Math.floor((STR_EIGHT.length-1)/2), Math.ceil((STR_EIGHT.length-1)/2+1))
...
let answerEight = monthsAndSeasons[MONTH]
