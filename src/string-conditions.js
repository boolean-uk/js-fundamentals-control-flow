...
console.log('1: Answer One:', answerOne)
...
console.log('2: Answer Two:', answerTwo)
...
console.log('3: Answer Three:', answerThree)
...
const firstLetter = STR_FIVE[0].toLowerCase
const lastLetter = STR_FIVE[STR_FIVE.length - 1].toLowerCase

let answerFour
if (firstLetter === lastLetter) {
  answerFour = true
}
console.log('4: Answer Four:', answerFour)
...
console.log('5: Answer Five:', answerFive)
...
console.log('6: Answer Six:', answerSix)
...
console.log('7: Answer 7:', answerSeven)
...
console.log('8: Answer Eight:', answerEight)
module.exports = {
  answerOne,
  answerTwo,
  answerThree,
