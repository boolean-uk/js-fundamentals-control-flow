...
let answerFour
if (STR_FIVE.toLowerCase().endsWith(STR_FIVE.toLowerCase()[0])) {
  answerFour = true
}
...
let answerFive
if (STR_SIX.toLowerCase().endsWith(STR_SIX.toLowerCase()[0])) {
  answerFive = true
} else {
  answerFive = false
}
...
if (STR_SEVEN.length % 2 === 1) {
  answerSix = STR_SEVEN[(STR_SEVEN.length / 2).toFixed(0) - 1]
}
