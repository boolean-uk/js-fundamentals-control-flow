...
const answerFour = STR_FIVE.endsWith(STR_FIVE[0].toLowerCase())
...
const answerFive = STR_FIVE.endsWith(STR_SIX[0].toLowerCase())
...
let answerSix
if (STR_SEVEN % 2 !== 0) {
  answerSix = STR_SEVEN.substring(2, 3)
}
...
let answerEight
if (MONTH === 'March' || MONTH === 'Aprils' || MONTH === 'May') {
  answerEight = 'Spring'
