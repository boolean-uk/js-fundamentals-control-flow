...
const length = STR_SEVEN.length

const answerSix =
  STR_SEVEN.length % 2 !== 0 ? STR_SEVEN[Math.floor(length / 2)] : null

// 7. Use conditional statements to set answerSeven to the middle two characters of
// STR_EIGHT if STR_EIGHT has an even number of characters
const STR_EIGHT = 'Alex' // eslint-disable-line no-unused-vars

const start = STR_EIGHT.length / 2 - 1
const answerSeven =
  STR_EIGHT.length % 2 === 0 ? STR_EIGHT.slice(start, start + 2) : null
