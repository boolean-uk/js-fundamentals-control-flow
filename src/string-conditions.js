...
const firstChar2 = STR_SIX.charAt(0).toLowerCase()
const lastChar2 = STR_SIX.charAt(STR_SIX.length - 1).toLowerCase()
...
const middleTwoLetters = STR_EIGHT.substring(1, 3)

if (STR_EIGHT.length % 2 === 0) {
  answerSeven = middleTwoLetters
}
