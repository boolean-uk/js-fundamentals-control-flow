...
if (STR_FIVE[0] === STR_FIVE[STR_FIVE.length-1] || STR_FIVE[0].toLowerCase() === STR_FIVE[STR_FIVE.length-1] || STR_FIVE[0] === STR_FIVE[STR_FIVE.length-1].toUpperCase() || STR_FIVE[0].toUpperCase() === STR_FIVE[STR_FIVE.length-1].toUpperCase()) {
  answerFour = true
}
...
if (STR_SIX[0] === STR_SIX[STR_SIX.length-1] || STR_SIX[0].toLowerCase() === STR_SIX[STR_SIX.length-1] || STR_SIX[0] === STR_SIX[STR_SIX.length-1].toUpperCase() || STR_SIX[0].toUpperCase() === STR_SIX[STR_SIX.length-1].toUpperCase()) {
  answerFive = true
} else {
  answerFive = false
}
