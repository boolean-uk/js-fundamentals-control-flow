...
console.log(Firstletter.toLowerCase === Lastletter)
...
const Firstletterfixlowercase = Firstlettersix.toLowerCase()
console.log(Firstletterfixlowercase === Lastlettersix)

if (Firstletterfixlowercase === Lastlettersix) {
  answerFive = true
} else {
  answerFive = false
}
...
if (STR_EIGHT.length % 2 === 0) {
  ...
  answerSeven = STR_EIGHT.substring(middleIndex - 1, 2)
}
