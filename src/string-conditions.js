...
let answerFour
if (STR_FIVE.toLowerCase().charAt(0) === STR_FIVE.toLowerCase().charAt(8)) {
  answerFour = true
}
...
let answerFive
if (STR_SIX.toLowerCase().charAt(0) === STR_SIX.toLowerCase().charAt(7)) {
  answerFive = true
} else {
  answerFive = false
}
...
if (STR_EIGHT.length % 2 === 0) {
  answerSeven =
    STR_EIGHT.charAt((STR_EIGHT.length - 1) / 2) +
