...
let answerOne;
if(STR_ONE === 'Hello') {
  console.log(answerOne=true)
} else {
  console.log(answerOne=false)
}
...
let answerTwo;
if(STR_TWO !== 'Hello') {
  console.log(answerTwo=true)
} else {
  console.log(answerTwo=false)
}
...
let answerFour;
if(STR_FIVE.charAt(0).toUpperCase()===STR_FIVE.charAt(STR_FIVE.length-1).toUpperCase()){
  console.log(answerFour = true)
} else {
  console.log(answerFour=false)
}
...
if(STR_SIX.charAt(0).toUpperCase!==STR_SIX.charAt(STR_SIX.length-1).toUpperCase){
  console.log(answerFive = true)
} else {
  console.log(answerFive=false)
}
...
let answerSeven;
if(STR_EIGHT.substring(1,3)%2!==0){
  answerSeven=STR_EIGHT.substring(1,3)
  console.log(answerSeven)
} else{
  console.log(answerSeven = false)
}
...
let answerEight;
if(MONTH === 'January') {
  console.log(answerEight='Winter')
} else {
  console.log(answerEight = 'Other')
}
