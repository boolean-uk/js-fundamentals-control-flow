...
const MTM = ['March', 'April', 'May']
const JTA = ['June', 'July', 'August']
const STN = ['September', 'October', 'November']
const DTF = ['December', 'January', 'February']

if (MTM.includes(MONTH)) {
  answerEight = 'Spring'
} else if (JTA.includes(MONTH)) {
  answerEight = 'Summer'
} else if (STN.includes(MONTH)) {
  answerEight = 'Autumn'
} else if (DTF.includes(MONTH)) {
  answerEight = 'Winter'
}
