...
let answerFour
if (
  STR_FIVE.charAt(0).toUpperCase() ===
  STR_FIVE.charAt(STR_FIVE.length - 1).toUpperCase()
) {
  answerFour = true
  console.log('4 - ', answerFour)
}
...
let answerFive
if (
  STR_SIX.charAt(0).toUpperCase() ===
  STR_SIX.charAt(STR_SIX.length - 1).toUpperCase()
) {
  answerFive = true
  console.log('5 - ', answerFive)
} else {
  answerFive = false
  console.log('5 - ', answerFive)
}
...
if (STR_EIGHT.length % 2 === 0) {
  ...
  const charMidOne = STR_EIGHT.charAt(eightLength / 2 - 1)
  const charMidTwo = STR_EIGHT.charAt(eightLength / 2)
  answerSeven = `${charMidOne}${charMidTwo}`
  // console.log(charMidOne)
  // console.log(charMidTwo)
  console.log('7 - ', answerSeven)
}
...
if (MONTH === 'December' || MONTH === 'January' || MONTH === 'February') {
  answerEight = 'Winter'
  console.log('8 - it is', answerEight)
  ...
  console.log('8 - this is not a month')
}
